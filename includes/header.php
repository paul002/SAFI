...
<head>
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/6283d6acb0d10b6f3e72af73/1g39ft5kb';
            s1.charset = 'UTF-8';
                                ...
                                <div class="main-menu-area">
                                    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="impact_areas.php">Impact Areas</a>
                                                <!-- <ul class="sub-menu">
                                            ...
                                            <li>
                                                <a class="active" href="project.php">Projects</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="gallery_02.php"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Gallery 02</a></li>
                                                    <li><a href="gallery_03.php"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Gallery 03</a></li>
                                                </ul>
                                            </li>
