...
$query = "SELECT * FROM `organogram` ORDER BY `position` ASC";
$row = $db->fetchQuery($query);
$organogramArray = array();
foreach($row as $organogram){
    extract($organogram);
    ...
    <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
        <button class="dropdown-item edit" data-id="'.$id.'" data-position="'.$position.'" data-description="'.$description.'" class="btn btn-primary"><i class="fas fa-fw fa-edit"></i> Edit</button>
...
echo json_encode($organogramArray);
exit;