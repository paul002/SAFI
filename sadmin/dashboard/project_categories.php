...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-tasks">&nbsp;&nbsp;</i>Project Categories</h1>
...
<script type="text/javascript">
    ...
    $('#project_form').on('submit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "scripts/add_project_category.php",
            data: formData,
            dataType: "json",
            contentType: false,
            cache: false,
    ...
    $('#projects_tbl').on('click', '.edit', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                document.getElementById('projectDialogLabel').innerHTML = "Edit Category";
    ...
    function newform() {
        ...
        document.getElementById('projectDialogLabel').innerHTML = "New Category";
    }
</script>